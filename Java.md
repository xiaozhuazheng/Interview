...
尾数位：尾数数据<br/>
指数位决定范围，尾数位决定精度。<br/>
float:指数8位，指数范围为-2^8-2^8,所以float的取值范围为-2^128-2^128;位数为23位。2^23 = 8388608,即float的有效位数为8位，精度6-7位；<br/>
double:指数11位，指数范围为-2^11-2^11,所以float的取值范围为-2^2048-2^2048;位数为52位。2^23 = 4503599627370496,即float的有效位数为16位，精度16位；<br/>
